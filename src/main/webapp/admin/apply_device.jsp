		...
		$.ajax({
			...
			success: function(data){
				...
				for(var i=0;i<data.length;i++){
					...
					inHtml +='<td><a href="../user/passApplyDevice.action?&apply_id='+data[i].apply_id+'" id="edit" class="layui-btn layui-btn-big">通过</a><a href="../user/notPassApplyDevice.action?&apply_id='+data[i].apply_id+'" id="del" class="layui-btn layui-btn-big">不通过</a></td></tr>';
				}
				$("#content").html(inHtml);
			},
			error: function(){
